...
def prep_bbox(sess, x, y, X_train, Y_train, X_test, Y_test,
    ...
    encoder, encoder_b, decoder_b, autoencoder_params, corrupt_prob = autoencoder("mnist", dimensions=[512, 128])
    model = make_basic(encoder, encoder_b, decoder_b, autoencoder_params,input_shape=(None, 28*28))
    ...
    def evaluate():
        ...
        acc,rec_error,re_true,re_false = model_eval_2(ess, x, y, corrupt_prob, preds, X_test, Y_test, args=eval_params, rec_cost=cost, x_shape_in=shape_in)
    ...
    model_train_2(sess, x, y, corrupt_prob, preds, X_train, Y_train, dataset, evaluate=evaluate,rec_cost=cost, args=train_params, rng=rng)
