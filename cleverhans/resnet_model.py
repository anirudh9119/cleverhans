...
def batch_norm_relu(inputs, is_training, data_format, block_id, center_and_scale=True):
  ...
  inputs = tf.layers.batch_normalization(
          ...
          momentum=_BATCH_NORM_DECAY, epsilon=_BATCH_NORM_EPSILON, center=center_and_scale,
          scale=center_and_scale, training=is_training, fused=True,name=name,reuse=reuse)
...
def conv2d_fixed_padding(inputs, filters, kernel_size, strides, data_format,block_id):
